...
const Index = ({ posts }) => {
  ...
  return (
    <>
      ...
      <p>These days I execute at <a href='http://inputlogic.ca'>the product studio</a> I started my friend <a href='https://geekforbrains.com'>Gavin</a> — we work with startups and huge brands to launch digital products.</p>
      <p>I try to be helpful, so if you have a question I can answer, feel free to <a href='mailto:shawn@nerdburn.com'>email me</a>.</p>
